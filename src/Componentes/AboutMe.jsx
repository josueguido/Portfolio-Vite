    ...
    return (
        <section className="flex flex-col md:grid md:grid-cols-2 py-10 px-10 " id="about">
            <div className="gap-x-10">
                ...
                <aside>
                    <a href="src/assets/JosueGuido_CV.docx.pdf" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" download>
                        Descargar CV
                    </a>
                </aside>
            </div>
