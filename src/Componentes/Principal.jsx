...
export function Principal() {
    return (
        <>
            <section className="relative flex  items-center justify-center overflow-hidden  border bg-background p-20 md:shadow-xl  flex-col  text-center md:items-start md:justify-start md:text-start px-10 gap-6" id="home">
