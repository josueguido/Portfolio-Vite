...
function Proyectos() {
    ...
    return (
        <>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 py-10 px-10 justify-center items-center text-start md:justify-center md:items-center" id="proyectos">
